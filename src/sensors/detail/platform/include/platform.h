...
#define VL53L5CX_ALIVE 1
#define VL53L5CX_FAIL  255
...
/**
 * @param (VL53L5CX_Platform*) platform : Pointer of VL53L5CX platform
 * structure.
...
uint8_t RdMulti(VL53L5CX_Platform* platform, uint16_t address, uint8_t* p_values, uint32_t size);
...
uint8_t WrMulti(VL53L5CX_Platform* platform, uint16_t address, uint8_t* p_values, uint32_t size);
 ...
 * @param (VL53L5CX_Platform*) platform : Pointer of VL53L5CX platform
 * structure.
 * @param (uint32_t) time : Time to wait in ms.
